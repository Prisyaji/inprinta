...
<head>
    ...
    <title>Inprinta Yogyakarta</title>
	<!-- Bootstrap Styles-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>"><h4>Inprinta Yogyakarta</h4></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="<?php echo base_url().'barang'?>"><i class="fa fa-bar-chart-o"></i> Ready Stock</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            ...
            <!-- /. PAGE INNER  -->
            <footer><p>Website : <a href="http://akbardesign.org" target="_blank">www.aji.org</a></p></footer>
        </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
    <!-- /. WRAPPER  -->
